...
import BackendAxios, { ClientAxios, FormAxios } from '@/lib/utils/axios';
...
const FundRequest = () => {
    ...
    function fetchTransactions(pageLink) {
        BackendAxios.get(pageLink || `/api/admin/fund/fetch-fund/${Cookies.get("viewUserId")}?page=1`).then((res) => {
            setPagination({

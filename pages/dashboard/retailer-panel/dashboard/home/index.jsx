...
const Index = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    BackendAxios.get(`/api/admin/user/overview/${Cookies.get("viewUserId")}?tenure=today`)
      .then((res) => {
        ...
        <Box>
          {/* <Box py={2} bgColor={"yellow.50"} mt={4} rounded={8}>
            <Marquee pauseOnHover={true} delay={3}>
              <Text>
                ...
                Enjoy great offers on mobile recharge!
              </Text>
            </Marquee>
          </Box> */}
          <HStack mt={8}>
            ...
            >
              ...
              <Box>
                ...
                <Text fontSize={["lg", "2xl"]} fontWeight={"semibold"}>
                  ₹ {Math.abs(payoutData?.credit - payoutData?.debit) || 0}
                </Text>
              </Box>
            </Stack>
            {/* <Stack
          ...
          >
            <HStack justifyContent={"space-between"}>
              <Text fontSize={"lg"} maxW={"50%"} fontWeight={"semibold"}>
                Boost Your Income With Us!
              </Text>
          ...
          <HStack pt={8}>
            ...
            >
              ...
              <Link href={"/dashboard/retailer-panel/dashboard/reports/dmt?pageId=reports"}>
                <Button colorScheme="whatsapp" size={"xs"} rounded={"full"}>
                  View
                </Button>
              </Link>
            </VStack>
            ...
            >
              ...
              <Link href={"/dashboard/retailer-panel/dashboard/reports/payout?pageId=reports"}>
                <Button colorScheme="whatsapp" size={"xs"} rounded={"full"}>
                  View
                </Button>
              </Link>
            ...
            >
              ...
              <Link href={"/dashboard/retailer-panel/dashboard/mobile/reports?pageId=reports"}>
                <Button colorScheme="facebook" size={"xs"} rounded={"full"}>
                  View All
                </Button>
              </Link>
            </VStack>
